...
export const CONFIG = {
    PORT: process.env.PORT || 21746,
    DATA_DIR: process.env.DATA_DIR || './data',
    CHAIN_ID: process.env.CHAIN_ID || 11155111, // Sepolia by default
    ...
    // Contracts (Sepolia Verified)
    CONTRACTS: {
        TOKEN: "0xEfC1a3dF358c4052B08406A3A530Da74eE96DA60",
        AD_MANAGER: "0x3B57c6e719A7b155b49E4842272F2B99E922Be4e",
        SUBSCRIPTIONS: "0x683A4Ed0c28F17D455cE3Ead21C372c1E6ed9524",
        NODE_REGISTRY: "0xaC13b1d7EB9F956fe72Fbe8950222be8A35ffDB7",
        GAS_POOL: "0x2cfAE62b67e1c2a5aF9e73Ac22B5cbCA8A30dAaB",
        LEADER_BOARD: "0x7A4E47F3192F8fcC1F92b0531fffdCb3ccF918B4",
        LINK_REGISTRY: "0x8E5c574e89ac6A8FbD7D3EB5584c628C5E7f4bCC",
        MEDIA_REGISTRY: "0x8252510Bd99D3742898a86d85403bF75759a280C",
...
export const ABIS = {
    ...
    AD_MANAGER: [
        ...
        "event CampaignCreated(uint256 indexed id, address indexed advertiser, string videoHash)"
    ],
    ERC20: [
